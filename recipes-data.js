...
// Edit the individual .json files in the /recipes folder instead.
...
window.recipesData = [
    {
        ...
        "steps":  [
                      "Boil water and cook the fettuccine pasta ({pasta}) according to package directions.",
                      "In a large skillet, melt the butter ({butter}) over medium heat.",
                      "Add the mushrooms ({mushrooms}) and sauté until browned.",
                      "Stir in the heavy cream ({cream}) and let it simmer for 5 minutes until slightly thickened.",
                      "Remove from heat, drizzle with truffle oil ({truffle_oil}), and toss with the cooked pasta."
                  ]
    },
    {
        "id":  2,
        ...
        "steps":  [
                      ...
                      "Rub the salmon ({salmon}) and asparagus ({asparagus}) with olive oil ({oil}), salt, and pepper.",
                      "Sear the salmon for 4-5 minutes per side until cooked through.",
                      "Grill the asparagus for 5-7 minutes until tender.",
                      "Drizzle everything with fresh lemon juice ({lemon}) before serving."
                  ]
    },
    {
        "id":  3,
        ...
        "steps":  [
                      ...
                      "Microwave chocolate ({chocolate}) and butter ({butter}) in a bowl until melted (about 1 minute).",
                      "Stir in powdered sugar ({sugar}) until well blended.",
                      "Whisk in eggs ({eggs}) and egg yolks ({yolks}).",
                      "Stir in flour ({flour}).",
    ...
    },
    {
        ...
        "steps":  [
                      "Sauté onion ({onion}) in oil ({oil}) until translucent, add garlic ({garlic}) and ground beef ({beef}). Brown the meat (about 5 minutes).",
                      "Add chili powder ({chili_powder}), cumin ({cumin}), oregano ({oregano}) and stir well.",
                      "Add beans ({beans}), tomatoes ({tomatoes}), beef broth ({broth}), and jalapeño peppers ({jalapeno}). Cook for about 20 minutes until the liquid thickens.",
